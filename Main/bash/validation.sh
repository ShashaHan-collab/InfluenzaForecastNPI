...
python script/moveandrename.py --lag 52 --region cni --tstart 201140 --tend 201852 --vstart 201901 --vend 201952 --pstart 202004 --pend 202004 --cov volume,vw --lsa 1e-05 --CI --targetname cncoefval --targetfolder result --sourcetype coef
...
python script/movetoexcel.py --sourcecsv cnval --targetexcel data/colleterialeffects/cn --targetsheetname val
# southern china
...
python script/moveandrename.py --lag 52 --region csib3 --tstart 201140 --tend 201852 --vstart 201901 --vend 201952 --pstart 202004 --pend 202004 --cov volume,vw --lsa 1e-05 --CI --targetname cscoefval --targetfolder result --sourcetype coef
...
python script/movetoexcel.py --sourcecsv csval --targetexcel data/colleterialeffects/cs --targetsheetname val
# uk
...
python script/moveandrename.py --lag 52 --region uk --tstart 201140 --tend 201852 --vstart 201901 --vend 201952 --pstart 202011 --pend 202011 --cov volume,vw --lsa 1e-05 --CI --targetname ukcoefval --targetfolder result --sourcetype coef
...
python script/movetoexcel.py --sourcecsv ukval --targetexcel data/colleterialeffects/uk --targetsheetname val
# usa
...
python script/moveandrename.py --lag 52 --region usa --tstart 201140 --tend 201852 --vstart 201901 --vend 201952 --pstart 202012 --pend 202012 --cov volume,vw --lsa 1e-05 --CI --targetname usacoefval --targetfolder result --sourcetype coef
...
python script/movetoexcel.py --sourcecsv usaval --targetexcel data/colleterialeffects/usa --targetsheetname val