...
python script/gen_data_plot.py --sourcecsv cnval --targetexcel data/colleterialeffects/cn --targetsheetname val
# southern china
...
python script/gen_data_plot.py --sourcecsv csval --targetexcel data/colleterialeffects/cs --targetsheetname val
# uk
...
python script/gen_data_plot.py --sourcecsv ukval --targetexcel data/colleterialeffects/uk --targetsheetname val
# usa
...
python script/gen_data_plot.py --sourcecsv usaval --targetexcel data/colleterialeffects/usa --targetsheetname val