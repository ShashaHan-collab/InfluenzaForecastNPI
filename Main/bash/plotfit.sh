...
python script/movetoexcel.py --sourcecsv cnhatyci --targetexcel data/colleterialeffects/cn --targetsheetname hatyci
# southern china
...
python script/movetoexcel.py --sourcecsv cshatyci --targetexcel data/colleterialeffects/cs --targetsheetname hatyci
# uk
...
python script/movetoexcel.py --sourcecsv ukhatyci --targetexcel data/colleterialeffects/uk --targetsheetname hatyci
# usa
...
python script/movetoexcel.py --sourcecsv usahatyci --targetexcel data/colleterialeffects/usa --targetsheetname hatyci
# plot mask model fit
# northern china
...
python script/movetoexcel.py --sourcecsv cnlrci --targetexcel data/colleterialeffects/cn --targetsheetname lrci
# southern china
...
python script/movetoexcel.py --sourcecsv cslrci --targetexcel data/colleterialeffects/cs --targetsheetname lrci
# uk
...
python script/movetoexcel.py --sourcecsv uklrci --targetexcel data/colleterialeffects/uk --targetsheetname lrci
# usa
...
python script/movetoexcel.py --sourcecsv usalrci --targetexcel data/colleterialeffects/usa --targetsheetname lrci
