...
python script/movetoexcel.py --sourcecsv cnmask45-50_d --targetexcel data/future/cn --targetsheetname mask45-50_d
...
python script/movetoexcel.py --sourcecsv cnmask51-4_d --targetexcel data/future/cn --targetsheetname mask51-4_d
...
python script/movetoexcel.py --sourcecsv cnmask_d --targetexcel data/future/cn --targetsheetname mask_d
# southern china
# make data
# mask wearing order for the full season
...
python script/movetoexcel.py --sourcecsv csmask45-50_d --targetexcel data/future/cs --targetsheetname mask45-50_d
# mask wearing order for the first half season
...
python script/movetoexcel.py --sourcecsv csmask51-4_d --targetexcel data/future/cs --targetsheetname mask51-4_d
# mask wearing order for the second half season
...
python script/movetoexcel.py --sourcecsv csmask_d --targetexcel data/future/cs --targetsheetname mask_d
# uk
# data
# mask wearing order for the full season
...
python script/movetoexcel.py --sourcecsv ukmask45-50_d --targetexcel data/future/uk --targetsheetname mask45-50_d
# mask wearing order for the first half season
...
python script/movetoexcel.py --sourcecsv ukmask51-4_d --targetexcel data/future/uk --targetsheetname mask51-4_d
# mask wearing order for the second half season
...
python script/movetoexcel.py --sourcecsv ukmask_d --targetexcel data/future/uk --targetsheetname mask_d
# usa
# make data
# mask wearing order for the full season
...
python script/movetoexcel.py --sourcecsv usamask45-50_d --targetexcel data/future/usa --targetsheetname mask45-50_d
# mask wearing order for the first half season
...
python script/movetoexcel.py --sourcecsv usamask51-4_d --targetexcel data/future/usa --targetsheetname mask51-4_d
# mask wearing order for the second half season
...
python script/movetoexcel.py --sourcecsv usamask_d --targetexcel data/future/usa --targetsheetname mask_d