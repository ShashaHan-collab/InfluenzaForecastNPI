...
python script/moveandrename.py --lag 52 --region cnlog --tstart 202004 --tend 202128 --pstart 202004 --pend 202252 --ctype new --clag 13 --yam cnihatynvmi --model lr --cpl a1 --noint --cpltp 202149 --cpled 202214 --targetname cnmask50ifirststage --targetfolder result
...
python script/movetoexcel.py --sourcecsv cnmask50i --targetexcel data/combinenpi/cn --targetsheetname mask50i
# mask + 50% international
# northern china
# make data
# mask wearing order for the full season
...
python script/moveandrename.py --lag 52 --region cnlog --tstart 202004 --tend 202128 --pstart 202004 --pend 202252 --ctype new --clag 13 --yam cnihatymvni --model lr --cpl a1 --noint --cpltp 202149 --cpled 202214 --targetname cnmask50vfirststage --targetfolder result
...
python script/movetoexcel.py --sourcecsv cnmask50v --targetexcel data/combinenpi/cn --targetsheetname mask50v
# northern china
...
python script/moveandrename.py --lag 52 --region cnimvmi --tstart 201140 --tend 202003 --pstart 202140 --pend 202252 --cov volume,vw --lsa 1e-05 --targetname cnihatymvmi
...
python script/movetoexcel.py --sourcecsv cnmvmi --targetexcel data/combinenpi/cn --targetsheetname mvmi
# southern china
# make data
# mask wearing order for the full season
...
python script/moveandrename.py --lag 52 --region cslog --tstart 202004 --tend 202128 --pstart 202004 --pend 202252 --ctype new --clag 11 --yam csihatynvmi --model lr --cpl a1 --noint --cpltp 202145 --cpled 202215 --targetname csmask50ifirststage --targetfolder result
...
python script/movetoexcel.py --sourcecsv csmask50i --targetexcel data/combinenpi/cs --targetsheetname mask50i
# southern china
# make data
# mask wearing order for the full season
...
python script/moveandrename.py --lag 52 --region cslog --tstart 202004 --tend 202128 --pstart 202004 --pend 202252 --ctype new --clag 11 --yam csihatymvni --model lr --cpl a1 --noint --cpltp 202145 --cpled 202215 --targetname csmask50vfirststage --targetfolder result
...
python script/movetoexcel.py --sourcecsv csmask50v --targetexcel data/combinenpi/cs --targetsheetname mask50v
# southern china
# prepare data
...
python script/moveandrename.py --lag 52 --region csimvmi --tstart 201140 --tend 202003 --pstart 202140 --pend 202252 --cov volume,vw --lsa 1e-05 --targetname csihatymvmi
...
python script/movetoexcel.py --sourcecsv csmvmi --targetexcel data/combinenpi/cs --targetsheetname mvmi
# uk
# data
# mask wearing order for the full season
...
python script/moveandrename.py --lag 52 --region uklog --tstart 202030 --tend 202128 --pstart 202030 --pend 202252 --ctype new --clag 24 --yam uk3hatynvmi --model lr --cpl a1 --noint --cpltp 202150 --cpled 202213 --targetname ukmask50ifirststage --targetfolder result
...
python script/movetoexcel.py --sourcecsv ukmask50i --targetexcel data/combinenpi/uk --targetsheetname mask50i
# uk
# data
# mask wearing order for the full season
...
python script/moveandrename.py --lag 52 --region uklog --tstart 202030 --tend 202128 --pstart 202030 --pend 202252 --ctype new --clag 24 --yam uk3hatymvni --model lr --cpl a1 --noint --cpltp 202150 --cpled 202213 --targetname ukmask50vfirststage --targetfolder result
...
python script/movetoexcel.py --sourcecsv ukmask50v --targetexcel data/combinenpi/uk --targetsheetname mask50v
# uk
# prepare data
...
python script/moveandrename.py --lag 52 --region ukmvmi --tstart 201140 --tend 202010 --pstart 202140 --pend 202252 --cov volume,vw --lsa 1e-05 --targetname uk3hatymvmi
# mitigate domestic mitigate international
...
python script/movetoexcel.py --sourcecsv rukmvmi --targetexcel data/combinenpi/uk --targetsheetname mvmi
# usa
# make data
# mask wearing order for the full season
...
python script/moveandrename.py --lag 52 --region usa --tstart 202014 --tend 202128 --pstart 202014 --pend 202252 --ctype new --clag 35 --yam usa3hatynvmi --model lr --cpl a1 --noint --cpltp 202148 --cpled 202215 --targetname usamask50ifirststage --targetfolder result
...
python script/movetoexcel.py --sourcecsv usamask50i --targetexcel data/combinenpi/usa --targetsheetname mask50i
# usa
# make data
# mask wearing order for the full season
...
python script/moveandrename.py --lag 52 --region usa --tstart 202014 --tend 202128 --pstart 202014 --pend 202252 --ctype new --clag 35 --yam usa3hatymvni --model lr --cpl a1 --noint --cpltp 202148 --cpled 202215 --targetname usamask50vfirststage --targetfolder result
...
python script/movetoexcel.py --sourcecsv usamask50v --targetexcel data/combinenpi/usa --targetsheetname mask50v
# usa
# prepare data
...
python script/moveandrename.py --lag 52 --region usamvmi --tstart 201140 --tend 202011 --pstart 202140 --pend 202252 --cov volume,vw --lsa 1e-05 --targetname usa3hatymvmi
# mitigate domestic mitigate international
...
python script/movetoexcel.py --sourcecsv rusamvmi --targetexcel data/combinenpi/usa --targetsheetname mvmi