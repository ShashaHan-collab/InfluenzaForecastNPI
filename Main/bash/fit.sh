...
python script/gen_data_plot.py --sourcecsv cnhatyci --targetexcel data/colleterialeffects/cn --targetsheetname hatyci
# southern china
...
python script/gen_data_plot.py --sourcecsv cshatyci --targetexcel data/colleterialeffects/cs --targetsheetname hatyci
# uk
...
python script/gen_data_plot.py --sourcecsv ukhatyci --targetexcel data/colleterialeffects/uk --targetsheetname hatyci
# usa
...
python script/gen_data_plot.py --sourcecsv usahatyci --targetexcel data/colleterialeffects/usa --targetsheetname hatyci
# plot mask model fit
# northern china
...
python script/gen_data_plot.py --sourcecsv cnlrci --targetexcel data/colleterialeffects/cn --targetsheetname lrci
# southern china
...
python script/gen_data_plot.py --sourcecsv cslrci --targetexcel data/colleterialeffects/cs --targetsheetname lrci
# uk
...
python script/gen_data_plot.py --sourcecsv uklrci --targetexcel data/colleterialeffects/uk --targetsheetname lrci
# usa
...
python script/gen_data_plot.py --sourcecsv usalrci --targetexcel data/colleterialeffects/usa --targetsheetname lrci
