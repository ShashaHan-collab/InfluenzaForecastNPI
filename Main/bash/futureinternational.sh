...
python script/gen_data_plot.py --sourcecsv cnnv3i --targetexcel data/future/cn --targetsheetname nv3i
...
python script/gen_data_plot.py --sourcecsv cnnv7i --targetexcel data/future/cn --targetsheetname nv7i
...
python script/gen_data_plot.py --sourcecsv cnnvmi --targetexcel data/future/cn --targetsheetname nvmi
python script/name_data.py --lag 52 --region cnlog --tstart 202004 --tend 202128 --pstart 202129 --pend 202252 --ctype new --clag 13 --yam cnihatynvmi --model lr --cpl a0 --noint --cpltp 202140 --targetname cn21mi --targetfolder data/ci
# southern china
# prepare data
...
python script/gen_data_plot.py --sourcecsv csnv3i --targetexcel data/future/cs --targetsheetname nv3i
...
python script/gen_data_plot.py --sourcecsv csnv7i --targetexcel data/future/cs --targetsheetname nv7i
...
python script/gen_data_plot.py --sourcecsv csnvmi --targetexcel data/future/cs --targetsheetname nvmi
python script/name_data.py --lag 52 --region cslog --tstart 202004 --tend 202128 --pstart 202129 --pend 202252 --ctype new --clag 11 --yam csihatynvmi --model lr --cpl a0 --noint --cpltp 202140 --targetname cs21mi --targetfolder data/ci
# uk
# prepare data
...
python script/gen_data_plot.py --sourcecsv ruknv3i --targetexcel data/future/uk --targetsheetname nv3i
...
python script/gen_data_plot.py --sourcecsv ruknv7i --targetexcel data/future/uk --targetsheetname nv7i
...
python script/gen_data_plot.py --sourcecsv ruknvmi --targetexcel data/future/uk --targetsheetname nvmi
python script/name_data.py --lag 52 --region uklog --tstart 202030 --tend 202128 --pstart 202129 --pend 202252 --ctype new --clag 24 --yam uk3hatynvmi --model lr --cpl a0 --noint --cpltp 202140 --targetname uk21mi --targetfolder data/ci
# usa
# prepare data
...
python script/gen_data_plot.py --sourcecsv rusanv3i --targetexcel data/future/usa --targetsheetname nv3i
...
python script/gen_data_plot.py --sourcecsv rusanv7i --targetexcel data/future/usa --targetsheetname nv7i
...
python script/gen_data_plot.py --sourcecsv rusanvmi --targetexcel data/future/usa --targetsheetname nvmi
python script/name_data.py --lag 52 --region usa --tstart 202014 --tend 202128 --pstart 202129 --pend 202252 --ctype new --clag 35 --yam usa3hatynvmi --model lr --cpl a0 --noint --cpltp 202140 --targetname usa21mi --targetfolder data/ci