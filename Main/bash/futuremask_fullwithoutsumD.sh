...
python script/gen_data_plot.py --sourcecsv cnmask45-50_fwd --targetexcel data/future/cn --targetsheetname mask45-50_fwd
...
python script/gen_data_plot.py --sourcecsv cnmask51-4_fwd --targetexcel data/future/cn --targetsheetname mask51-4_fwd
...
python script/gen_data_plot.py --sourcecsv cnmask_fwd --targetexcel data/future/cn --targetsheetname mask_fwd
# southern china
# make data
# mask wearing order for the full season
...
python script/gen_data_plot.py --sourcecsv csmask45-50_fwd --targetexcel data/future/cs --targetsheetname mask45-50_fwd
# mask wearing order for the first half season
...
python script/gen_data_plot.py --sourcecsv csmask51-4_fwd --targetexcel data/future/cs --targetsheetname mask51-4_fwd
# mask wearing order for the second half season
...
python script/gen_data_plot.py --sourcecsv csmask_fwd --targetexcel data/future/cs --targetsheetname mask_fwd
# uk
# data
# mask wearing order for the full season
...
python script/gen_data_plot.py --sourcecsv ukmask45-50_fwd --targetexcel data/future/uk --targetsheetname mask45-50_fwd
# mask wearing order for the first half season
...
python script/gen_data_plot.py --sourcecsv ukmask51-4_fwd --targetexcel data/future/uk --targetsheetname mask51-4_fwd
# mask wearing order for the second half season
...
python script/gen_data_plot.py --sourcecsv ukmask_fwd --targetexcel data/future/uk --targetsheetname mask_fwd
# usa
# make data
# mask wearing order for the full season
...
python script/gen_data_plot.py --sourcecsv usamask45-50_fwd --targetexcel data/future/usa --targetsheetname mask45-50_fwd
# mask wearing order for the first half season
...
python script/gen_data_plot.py --sourcecsv usamask51-4_fwd --targetexcel data/future/usa --targetsheetname mask51-4_fwd
# mask wearing order for the second half season
...
python script/gen_data_plot.py --sourcecsv usamask_fwd --targetexcel data/future/usa --targetsheetname mask_fwd
