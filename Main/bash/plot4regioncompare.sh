...
python script/moveandrename.py --lag 52 --region cnlog --tstart 202004 --tend 202128 --pstart 202128 --pend 202252 --ctype new --clag 13 --yam cnihatyfmsn --model lr --cpl a0 --noint --cpltp 202140 --targetname cn21nomask --targetfolder data/ci
...
python script/movetoexcel.py --sourcecsv cn21nomask --targetexcel data/future/cn --targetsheetname no
# southern china
# # no
...
python script/moveandrename.py --lag 52 --region cslog --tstart 202004 --tend 202128 --pstart 202128 --pend 202252 --ctype new --clag 11 --yam csihatyfmsn --model lr --cpl a0 --noint --cpltp 202140 --targetname cs21nomask --targetfolder data/ci
...
python script/movetoexcel.py --sourcecsv cs21nomask --targetexcel data/future/cs --targetsheetname no
# uk
# no
...
python script/moveandrename.py --lag 52 --region uklog --tstart 202030 --tend 202128 --pstart 202128 --pend 202252 --ctype new --clag 24 --yam uk3hatyfmsn --model lr --cpl a0 --noint --cpltp 202140 --targetname uk21nomask --targetfolder data/ci
...
python script/movetoexcel.py --sourcecsv uk21nomask --targetexcel data/future/uk --targetsheetname no
# usa
# no
...
python script/moveandrename.py --lag 52 --region usa --tstart 202014 --tend 202128 --pstart 202128 --pend 202252 --ctype new --clag 35 --yam usa3hatyfmsn --model lr --cpl a0 --noint --cpltp 202140  --targetname usa21nomask --targetfolder data/ci
...
python script/movetoexcel.py --sourcecsv usa21nomask --targetexcel data/future/usa --targetsheetname no