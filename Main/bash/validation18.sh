...
python script/gen_data_plot.py --sourcecsv cnval18 --targetexcel data/colleterialeffects/cn --targetsheetname val18
# southern china
...
python script/gen_data_plot.py --sourcecsv csval18 --targetexcel data/colleterialeffects/cs --targetsheetname val18
# uk
...
python script/gen_data_plot.py --sourcecsv ukval18 --targetexcel data/colleterialeffects/uk --targetsheetname val18
# usa
...
python script/gen_data_plot.py --sourcecsv usaval18 --targetexcel data/colleterialeffects/usa --targetsheetname val18