...
python script/gen_data_plot.py --sourcecsv cn3vni --targetexcel data/future/cn --targetsheetname 3vni
...
python script/gen_data_plot.py --sourcecsv cn7vni --targetexcel data/future/cn --targetsheetname 7vni
...
python script/gen_data_plot.py --sourcecsv cnmvni --targetexcel data/future/cn --targetsheetname mvni
python script/name_data.py --lag 52 --region cnlog --tstart 202004 --tend 202128 --pstart 202129 --pend 202252 --ctype new --clag 13 --yam cnihatymvni --model lr --cpl a0 --noint --cpltp 202140 --targetname cn21mv --targetfolder data/ci
# southern china
# prepare data
...
python script/gen_data_plot.py --sourcecsv cs3vni --targetexcel data/future/cs --targetsheetname 3vni
...
python script/gen_data_plot.py --sourcecsv cs7vni --targetexcel data/future/cs --targetsheetname 7vni
...
python script/gen_data_plot.py --sourcecsv csmvni --targetexcel data/future/cs --targetsheetname mvni
python script/name_data.py --lag 52 --region cslog --tstart 202004 --tend 202128 --pstart 202129 --pend 202252 --ctype new --clag 11 --yam csihatymvni --model lr --cpl a0 --noint --cpltp 202140 --targetname cs21mv --targetfolder data/ci
# uk
# prepare data
...
python script/gen_data_plot.py --sourcecsv ruk3vni --targetexcel data/future/uk --targetsheetname 3vni
...
python script/gen_data_plot.py --sourcecsv ruk7vni --targetexcel data/future/uk --targetsheetname 7vni
...
python script/gen_data_plot.py --sourcecsv rukmvni --targetexcel data/future/uk --targetsheetname mvni
python script/name_data.py --lag 52 --region uklog --tstart 202030 --tend 202128 --pstart 202129 --pend 202252 --ctype new --clag 24 --yam uk3hatymvni --model lr --cpl a0 --noint --cpltp 202140 --targetname uk21mv --targetfolder data/ci
# usa
# prepare data
...
python script/gen_data_plot.py --sourcecsv rusa3vni --targetexcel data/future/usa --targetsheetname 3vni
...
python script/gen_data_plot.py --sourcecsv rusa7vni --targetexcel data/future/usa --targetsheetname 7vni
...
python script/gen_data_plot.py --sourcecsv rusamvni --targetexcel data/future/usa --targetsheetname mvni
python script/name_data.py --lag 52 --region usa --tstart 202014 --tend 202128 --pstart 202129 --pend 202252 --ctype new --clag 35 --yam usa3hatymvni --model lr --cpl a0 --noint --cpltp 202140 --targetname usa21mv --targetfolder data/ci