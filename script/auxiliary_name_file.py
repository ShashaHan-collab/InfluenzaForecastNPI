# Called by the bash script. This scrpit can move and rename the predicted flu/coefficient data file generated by estimation_forecast.py to other names. This is because the name of the output of estimation_forecast.py are tedius and set to contain the parameters used.
import pandas as pd
from utils import *
import numpy as np
