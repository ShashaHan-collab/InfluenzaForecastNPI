# Called by the bash script. This script reads in the predicted value that generated by estimation_forecast.py, calculates the mean and upper/lower bound line. The mean and upper/lower bound line will be later used for generation of source data for plotting.
