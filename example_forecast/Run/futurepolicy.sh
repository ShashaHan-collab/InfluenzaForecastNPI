...
python script/auxiliary_gen_excel_data.py --sourcecsv cnmask50i --targetexcel preprocessed_data/combinenpi/cn --targetsheetname mask50i
# mask + 50% international
# northern china
# make data
# mask wearing order for the full season
...
python script/auxiliary_gen_excel_data.py --sourcecsv cnmask50v --targetexcel preprocessed_data/combinenpi/cn --targetsheetname mask50v
# northern china
...
python script/auxiliary_gen_excel_data.py --sourcecsv cnmvmi --targetexcel preprocessed_data/combinenpi/cn --targetsheetname mvmi
# southern china
# make data
# mask wearing order for the full season
...
python script/auxiliary_gen_excel_data.py --sourcecsv csmask50i --targetexcel preprocessed_data/combinenpi/cs --targetsheetname mask50i
# southern china
# make data
# mask wearing order for the full season
...
python script/auxiliary_gen_excel_data.py --sourcecsv csmask50v --targetexcel preprocessed_data/combinenpi/cs --targetsheetname mask50v
# southern china
# prepare data
...
python script/auxiliary_gen_excel_data.py --sourcecsv csmvmi --targetexcel preprocessed_data/combinenpi/cs --targetsheetname mvmi
# uk
# data
# mask wearing order for the full season
...
python script/auxiliary_gen_excel_data.py --sourcecsv ukmask50i --targetexcel preprocessed_data/combinenpi/uk --targetsheetname mask50i
# uk
# data
# mask wearing order for the full season
...
python script/auxiliary_gen_excel_data.py --sourcecsv ukmask50v --targetexcel preprocessed_data/combinenpi/uk --targetsheetname mask50v
# uk
# prepare data
...
python script/auxiliary_gen_excel_data.py --sourcecsv rukmvmi --targetexcel preprocessed_data/combinenpi/uk --targetsheetname mvmi
# usa
# make data
# mask wearing order for the full season
...
python script/auxiliary_gen_excel_data.py --sourcecsv usamask50i --targetexcel preprocessed_data/combinenpi/usa --targetsheetname mask50i
# usa
# make data
# mask wearing order for the full season
...
python script/auxiliary_gen_excel_data.py --sourcecsv usamask50v --targetexcel preprocessed_data/combinenpi/usa --targetsheetname mask50v
# usa
# prepare data
...
python script/auxiliary_gen_excel_data.py --sourcecsv rusamvmi --targetexcel preprocessed_data/combinenpi/usa --targetsheetname mvmi