...
python script/auxiliary_gen_excel_data.py --sourcecsv cnnovaccine_30 --targetexcel preprocessed_data/future/cn --targetsheetname novaccine_30
...
python script/auxiliary_name_file.py --lag 52 --region cni --tstart 201140 --tend 202003 --pstart 202004 --pend 202252 --cov volume,vw --lsa 1e-05 --vaccine 0.88 --targetname cnihatymvaccine --targetfolder data --movetype mean
...
python script/auxiliary_name_file.py --lag 52 --region cniv2 --tstart 201140 --tend 202003 --pstart 202140 --pend 202252 --cov volume,vw --lsa 1e-05 --vaccine 0.88 --targetname cnihatyv2vaccine --targetfolder data
...
python script/auxiliary_name_file.py --lag 52 --region cnlog --tstart 202004 --tend 202128 --pstart 202128 --pend 202252 --ctype new --clag 13 --yam cnihatyv2vaccine --model lr --cpl a0 --noint --cpltp 202140 --targetname cnvaccine --targetfolder preprocessed_data/ci
...
python script/auxiliary_gen_excel_data.py --sourcecsv cnvaccine --targetexcel preprocessed_data/future/cn --targetsheetname vaccine
...
python script/auxiliary_gen_excel_data.py --sourcecsv cnvaccine_30 --targetexcel preprocessed_data/future/cn --targetsheetname vaccine_30
# southern china
# make data
# flu level with novaccine and mask level at 30%
...
python script/auxiliary_gen_excel_data.py --sourcecsv csnovaccine_30 --targetexcel preprocessed_data/future/cs --targetsheetname novaccine_30
# make flu level with vaccination under mitigate travel volume
...
python script/auxiliary_name_file.py --lag 52 --region csib3 --tstart 201140 --tend 202003 --pstart 202004 --pend 202252 --cov volume,vw --lsa 1e-05 --vaccine 0.88 --targetname csihatymvaccine --targetfolder data --movetype mean
...
python script/auxiliary_name_file.py --lag 52 --region csiv2b3 --tstart 201140 --tend 202003 --pstart 202140 --pend 202252 --cov volume,vw --lsa 1e-05 --vaccine 0.88 --targetname csihatyv2vaccine --targetfolder data
...
python script/auxiliary_name_file.py --lag 52 --region cslog --tstart 202004 --tend 202128 --pstart 202128 --pend 202252 --ctype new --clag 11 --yam csihatyv2vaccine --model lr --cpl a0 --noint --cpltp 202140 --targetname csvaccine --targetfolder preprocessed_data/ci
...
python script/auxiliary_gen_excel_data.py --sourcecsv csvaccine --targetexcel preprocessed_data/future/cs --targetsheetname vaccine
# flu level with vaccination and with mask wearing at 30%
...
python script/auxiliary_gen_excel_data.py --sourcecsv csvaccine_30 --targetexcel preprocessed_data/future/cs --targetsheetname vaccine_30
# uk
# data
# flu level with novaccine and mask level at 30%
...
python script/auxiliary_gen_excel_data.py --sourcecsv uknovaccine_30 --targetexcel preprocessed_data/future/uk --targetsheetname novaccine_30
# make flu level with vaccination under mitigate travel volume
...
python script/auxiliary_name_file.py --lag 52 --region uk --tstart 201140 --tend 202010 --pstart 202011 --pend 202252 --cov volume,vw --lsa 1e-05 --vaccine 0.88 --targetname uk3hatymvaccine --targetfolder data --movetype mean
...
python script/auxiliary_name_file.py --lag 52 --region ukv2 --tstart 201140 --tend 202010 --pstart 202140 --pend 202252 --cov volume,vw --lsa 1e-05 --vaccine 0.88 --targetname uk3hatyv2vaccine --targetfolder data
...
python script/auxiliary_name_file.py --lag 52 --region uklog --tstart 202030 --tend 202128 --pstart 202128 --pend 202252 --ctype new --clag 24 --yam uk3hatyv2vaccine --model lr --cpl a0 --noint --cpltp 202140 --targetname ukvaccine --targetfolder preprocessed_data/ci
...
python script/auxiliary_gen_excel_data.py --sourcecsv ukvaccine --targetexcel preprocessed_data/future/uk --targetsheetname vaccine
# flu level with vaccination and with mask wearing at 30%
...
python script/auxiliary_gen_excel_data.py --sourcecsv ukvaccine_30 --targetexcel preprocessed_data/future/uk --targetsheetname vaccine_30
# usa
# make data
# flu level with novaccine and mask level at 30%
...
python script/auxiliary_gen_excel_data.py --sourcecsv usanovaccine_30 --targetexcel preprocessed_data/future/usa --targetsheetname novaccine_30
# make flu level with vaccination under mitigate travel volume
...
python script/auxiliary_name_file.py --lag 52 --region usa --tstart 201140 --tend 202011 --pstart 202012 --pend 202252 --cov volume,vw --lsa 1e-05 --vaccine 0.88 --targetname usa3hatymvaccine --targetfolder data --movetype mean
...
python script/auxiliary_name_file.py --lag 52 --region usav2 --tstart 201140 --tend 202011 --pstart 202140 --pend 202252 --cov volume,vw --lsa 1e-05 --vaccine 0.88 --targetname usa3hatyv2vaccine --targetfolder data
...
python script/auxiliary_name_file.py --lag 52 --region usa --tstart 202014 --tend 202128 --pstart 202128 --pend 202252 --ctype new --clag 35 --yam usa3hatyv2vaccine --model lr --cpl a0 --noint --cpltp 202140  --targetname usavaccine --targetfolder preprocessed_data/ci
...
python script/auxiliary_gen_excel_data.py --sourcecsv usavaccine --targetexcel preprocessed_data/future/usa --targetsheetname vaccine
# flu level with vaccination and with mask wearing at 30%
...
python script/auxiliary_gen_excel_data.py --sourcecsv usavaccine_30 --targetexcel preprocessed_data/future/usa --targetsheetname vaccine_30
