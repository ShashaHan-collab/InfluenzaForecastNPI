...
python script/auxiliary_gen_excel_data.py --sourcecsv cn3vni --targetexcel preprocessed_data/future/cn --targetsheetname 3vni
...
python script/auxiliary_gen_excel_data.py --sourcecsv cn7vni --targetexcel preprocessed_data/future/cn --targetsheetname 7vni
...
python script/auxiliary_gen_excel_data.py --sourcecsv cnmvni --targetexcel preprocessed_data/future/cn --targetsheetname mvni
python script/auxiliary_name_file.py --lag 52 --region cnlog --tstart 202004 --tend 202128 --pstart 202129 --pend 202252 --ctype new --clag 13 --yam cnihatymvni --model lr --cpl a0 --noint --cpltp 202140 --targetname cn21mv --targetfolder preprocessed_data/ci
# southern china
# prepare data
...
python script/auxiliary_gen_excel_data.py --sourcecsv cs3vni --targetexcel preprocessed_data/future/cs --targetsheetname 3vni
...
python script/auxiliary_gen_excel_data.py --sourcecsv cs7vni --targetexcel preprocessed_data/future/cs --targetsheetname 7vni
...
python script/auxiliary_gen_excel_data.py --sourcecsv csmvni --targetexcel preprocessed_data/future/cs --targetsheetname mvni
python script/auxiliary_name_file.py --lag 52 --region cslog --tstart 202004 --tend 202128 --pstart 202129 --pend 202252 --ctype new --clag 11 --yam csihatymvni --model lr --cpl a0 --noint --cpltp 202140 --targetname cs21mv --targetfolder preprocessed_data/ci
# uk
# prepare data
...
python script/auxiliary_gen_excel_data.py --sourcecsv ruk3vni --targetexcel preprocessed_data/future/uk --targetsheetname 3vni
...
python script/auxiliary_gen_excel_data.py --sourcecsv ruk7vni --targetexcel preprocessed_data/future/uk --targetsheetname 7vni
...
python script/auxiliary_gen_excel_data.py --sourcecsv rukmvni --targetexcel preprocessed_data/future/uk --targetsheetname mvni
python script/auxiliary_name_file.py --lag 52 --region uklog --tstart 202030 --tend 202128 --pstart 202129 --pend 202252 --ctype new --clag 24 --yam uk3hatymvni --model lr --cpl a0 --noint --cpltp 202140 --targetname uk21mv --targetfolder preprocessed_data/ci
# usa
# prepare data
...
python script/auxiliary_gen_excel_data.py --sourcecsv rusa3vni --targetexcel preprocessed_data/future/usa --targetsheetname 3vni
...
python script/auxiliary_gen_excel_data.py --sourcecsv rusa7vni --targetexcel preprocessed_data/future/usa --targetsheetname 7vni
...
python script/auxiliary_gen_excel_data.py --sourcecsv rusamvni --targetexcel preprocessed_data/future/usa --targetsheetname mvni
python script/auxiliary_name_file.py --lag 52 --region usa --tstart 202014 --tend 202128 --pstart 202129 --pend 202252 --ctype new --clag 35 --yam usa3hatymvni --model lr --cpl a0 --noint --cpltp 202140 --targetname usa21mv --targetfolder preprocessed_data/ci