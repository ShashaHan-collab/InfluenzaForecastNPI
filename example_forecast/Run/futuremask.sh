...
python script/auxiliary_gen_excel_data.py --sourcecsv cnmask45-50 --targetexcel result/future/cn --targetsheetname mask45-50
...
python script/auxiliary_gen_excel_data.py --sourcecsv cnmask51-4 --targetexcel result/future/cn --targetsheetname mask51-4
...
python script/auxiliary_gen_excel_data.py --sourcecsv cnmask --targetexcel result/future/cn --targetsheetname mask
python script/auxiliary_name_file.py --lag 52 --region cnlog --tstart 202004 --tend 202128 --pstart 202004 --pend 202252 --ctype new --clag 13 --yam cnihatyfmsn --model lr --cpl a1 --noint --cpltp 202149 --cpled 202214 --targetname cn21mask --targetfolder result/ci
# southern china
# make data
# mask wearing order for the full season
...
python script/auxiliary_gen_excel_data.py --sourcecsv csmask45-50 --targetexcel result/future/cs --targetsheetname mask45-50
# mask wearing order for the first half season
...
python script/auxiliary_gen_excel_data.py --sourcecsv csmask51-4 --targetexcel result/future/cs --targetsheetname mask51-4
# mask wearing order for the second half season
...
python script/auxiliary_gen_excel_data.py --sourcecsv ukmask45-50 --targetexcel result/future/uk --targetsheetname mask45-50
# mask wearing order for the first half season
...
python script/auxiliary_gen_excel_data.py --sourcecsv ukmask51-4 --targetexcel result/future/uk --targetsheetname mask51-4
# mask wearing order for the second half season
...
python script/auxiliary_gen_excel_data.py --sourcecsv ukmask --targetexcel result/future/uk --targetsheetname mask
python script/auxiliary_name_file.py --lag 52 --region uklog --tstart 202030 --tend 202128 --pstart 202030 --pend 202252 --ctype new --clag 24 --yam uk3hatyfmsn --model lr --cpl a1 --noint --cpltp 202150 --cpled 202213 --targetname uk21mask --targetfolder result/ci
# usa
# make data
# mask wearing order for the full season
...
python script/auxiliary_gen_excel_data.py --sourcecsv usamask45-50 --targetexcel result/future/usa --targetsheetname mask45-50
# mask wearing order for the first half season
...
python script/auxiliary_gen_excel_data.py --sourcecsv usamask51-4 --targetexcel result/future/usa --targetsheetname mask51-4
# mask wearing order for the second half season
...
python script/auxiliary_gen_excel_data.py --sourcecsv usamask --targetexcel result/future/usa --targetsheetname mask
python script/auxiliary_name_file.py --lag 52 --region usa --tstart 202014 --tend 202128 --pstart 202014 --pend 202252 --ctype new --clag 35 --yam usa3hatyfmsn --model lr --cpl a1 --noint --cpltp 202148 --cpled 202215 --targetname usa21mask --targetfolder result/ci
