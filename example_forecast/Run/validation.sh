...
python script/auxiliary_gen_excel_data.py --sourcecsv cnval --targetexcel preprocessed_data/colleterialeffects/cn --targetsheetname val
# southern china
...
python script/auxiliary_gen_excel_data.py --sourcecsv csval --targetexcel preprocessed_data/colleterialeffects/cs --targetsheetname val
# uk
...
python script/auxiliary_gen_excel_data.py --sourcecsv ukval --targetexcel preprocessed_data/colleterialeffects/uk --targetsheetname val
# usa
...
python script/auxiliary_gen_excel_data.py --sourcecsv usaval --targetexcel preprocessed_data/colleterialeffects/usa --targetsheetname val