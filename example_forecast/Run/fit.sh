...
python script/auxiliary_gen_excel_data.py --sourcecsv cnhatyci --targetexcel preprocessed_data/colleterialeffects/cn --targetsheetname hatyci
# southern china
...
python script/auxiliary_gen_excel_data.py --sourcecsv cshatyci --targetexcel preprocessed_data/colleterialeffects/cs --targetsheetname hatyci
# uk
...
python script/auxiliary_gen_excel_data.py --sourcecsv ukhatyci --targetexcel preprocessed_data/colleterialeffects/uk --targetsheetname hatyci
# usa
...
python script/auxiliary_gen_excel_data.py --sourcecsv usahatyci --targetexcel preprocessed_data/colleterialeffects/usa --targetsheetname hatyci
# plot mask model fit
# northern china
...
python script/auxiliary_gen_excel_data.py --sourcecsv cnlrci --targetexcel preprocessed_data/colleterialeffects/cn --targetsheetname lrci
# southern china
...
python script/auxiliary_gen_excel_data.py --sourcecsv cslrci --targetexcel preprocessed_data/colleterialeffects/cs --targetsheetname lrci
# uk
...
python script/auxiliary_gen_excel_data.py --sourcecsv uklrci --targetexcel preprocessed_data/colleterialeffects/uk --targetsheetname lrci
# usa
...
python script/auxiliary_gen_excel_data.py --sourcecsv usalrci --targetexcel preprocessed_data/colleterialeffects/usa --targetsheetname lrci
