...
python script/auxiliary_gen_excel_data.py --sourcecsv cnnv3i --targetexcel preprocessed_data/future/cn --targetsheetname nv3i
...
python script/auxiliary_gen_excel_data.py --sourcecsv cnnv7i --targetexcel preprocessed_data/future/cn --targetsheetname nv7i
...
python script/auxiliary_gen_excel_data.py --sourcecsv cnnvmi --targetexcel preprocessed_data/future/cn --targetsheetname nvmi
python script/auxiliary_name_file.py --lag 52 --region cnlog --tstart 202004 --tend 202128 --pstart 202129 --pend 202252 --ctype new --clag 13 --yam cnihatynvmi --model lr --cpl a0 --noint --cpltp 202140 --targetname cn21mi --targetfolder preprocessed_data/ci
# southern china
# prepare data
...
python script/auxiliary_gen_excel_data.py --sourcecsv csnv3i --targetexcel preprocessed_data/future/cs --targetsheetname nv3i
...
python script/auxiliary_gen_excel_data.py --sourcecsv csnv7i --targetexcel preprocessed_data/future/cs --targetsheetname nv7i
...
python script/auxiliary_gen_excel_data.py --sourcecsv csnvmi --targetexcel preprocessed_data/future/cs --targetsheetname nvmi
python script/auxiliary_name_file.py --lag 52 --region cslog --tstart 202004 --tend 202128 --pstart 202129 --pend 202252 --ctype new --clag 11 --yam csihatynvmi --model lr --cpl a0 --noint --cpltp 202140 --targetname cs21mi --targetfolder preprocessed_data/ci
# uk
# prepare data
...
python script/auxiliary_gen_excel_data.py --sourcecsv ruknv3i --targetexcel preprocessed_data/future/uk --targetsheetname nv3i
...
python script/auxiliary_gen_excel_data.py --sourcecsv ruknv7i --targetexcel preprocessed_data/future/uk --targetsheetname nv7i
...
python script/auxiliary_gen_excel_data.py --sourcecsv ruknvmi --targetexcel preprocessed_data/future/uk --targetsheetname nvmi
python script/auxiliary_name_file.py --lag 52 --region uklog --tstart 202030 --tend 202128 --pstart 202129 --pend 202252 --ctype new --clag 24 --yam uk3hatynvmi --model lr --cpl a0 --noint --cpltp 202140 --targetname uk21mi --targetfolder preprocessed_data/ci
# usa
# prepare data
...
python script/auxiliary_gen_excel_data.py --sourcecsv rusanv3i --targetexcel preprocessed_data/future/usa --targetsheetname nv3i
...
python script/auxiliary_gen_excel_data.py --sourcecsv rusanv7i --targetexcel preprocessed_data/future/usa --targetsheetname nv7i
...
python script/auxiliary_gen_excel_data.py --sourcecsv rusanvmi --targetexcel preprocessed_data/future/usa --targetsheetname nvmi
python script/auxiliary_name_file.py --lag 52 --region usa --tstart 202014 --tend 202128 --pstart 202129 --pend 202252 --ctype new --clag 35 --yam usa3hatynvmi --model lr --cpl a0 --noint --cpltp 202140 --targetname usa21mi --targetfolder preprocessed_data/ci