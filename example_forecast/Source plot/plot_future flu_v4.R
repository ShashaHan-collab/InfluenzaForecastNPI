rm(list = ls())
setwd("~/InfluenzaForecastNPI-main/example_forecast/")
library(tidyverse)
library(glue)
library(xlsx)
library(cowplot)
...
#####
# load data
no<-read.xlsx("Source Data/plot_future flu_v4/cn.xlsx", sheetName = "no")
mask<-read.xlsx("Source Data/plot_future flu_v4/cn.xlsx", sheetName = "mask")
mvni<-read.xlsx("Source Data/plot_future flu_v4/cn.xlsx", sheetName = "mvni")
nvmi<-read.xlsx("Source Data/plot_future flu_v4/cn.xlsx", sheetName = "nvmi")
...
plotf_mask_cn <-ggplot()+
  ...
  scale_shape_manual(values = c(0, 1, 2, 4), 
                     name = "Treatment")+
  annotate("text", label = "Mask full season, Northern China", x = 25, y =  0.49 * scale, color = "#8B658B",fontface = 'bold')+
...
#####
# load data
no<-read.xlsx("Source Data/plot_future flu_v4/cs.xlsx", sheetName = "no")
mask<-read.xlsx("Source Data/plot_future flu_v4/cs.xlsx", sheetName = "mask")
mvni<-read.xlsx("Source Data/plot_future flu_v4/cs.xlsx", sheetName = "mvni")
nvmi<-read.xlsx("Source Data/plot_future flu_v4/cs.xlsx", sheetName = "nvmi")
...
plotf_mask_cs <-ggplot()+
  ...
  scale_shape_manual(values = c(0, 1, 2, 4), 
                     name = "Treatment")+
  annotate("text", label = "Mask full season, Southern China", x = 25, y =  0.49 * scale, color = "#8B658B",fontface = 'bold')+
  labs( x="", y = "Percent Positive (%)") +
  scale_x_continuous(breaks=xlabelpos, label=xlabel)+
  scale_y_continuous(limits = c(0, ylimits), breaks = seq(0, ylimits, by = 0.1* scale)) +
  theme_classic() +
...
#####
# load data
no<-read.xlsx("Source Data/plot_future flu_v4/uk.xlsx", sheetName = "no")
mask<-read.xlsx("Source Data/plot_future flu_v4/uk.xlsx", sheetName = "mask")
mvni<-read.xlsx("Source Data/plot_future flu_v4/uk.xlsx", sheetName = "mvni")
nvmi<-read.xlsx("Source Data/plot_future flu_v4/uk.xlsx", sheetName = "nvmi")
...
plotf_mask_uk <-ggplot()+
  ...
  scale_shape_manual(values = c(0, 1, 2, 4), 
                     name = "Treatment")+
  annotate("text", label = "Mask full season, England", x = 25, y =  0.49 * scale, color = "#8B658B",fontface = 'bold')+
  labs(x="",  y = "Percent Positive (%)") +
  scale_x_continuous(breaks=xlabelpos, label=xlabel)+
  scale_y_continuous(limits = c(0, ylimits), breaks = seq(0, ylimits, by = 0.1* scale)) +
  theme_classic() +
...
#####
# load data
no<-read.xlsx("Source Data/plot_future flu_v4/usa.xlsx", sheetName = "no")
mask<-read.xlsx("Source Data/plot_future flu_v4/usa.xlsx", sheetName = "mask")
mvni<-read.xlsx("Source Data/plot_future flu_v4/usa.xlsx", sheetName = "mvni")
nvmi<-read.xlsx("Source Data/plot_future flu_v4/usa.xlsx", sheetName = "nvmi")
...
plotf_mask_usa <-ggplot()+
  ...
  scale_shape_manual(values = c(0, 1, 2, 4), 
                     name = "Treatment")+
  annotate("text", label = "Mask full season, the U.S.", x = 25, y =  0.49 * scale, color = "#8B658B",fontface = 'bold')+
  labs(x="", y = "Percent Positive (%)") +
  scale_x_continuous(breaks=xlabelpos, label=xlabel)+
  scale_y_continuous(limits = c(0, ylimits), breaks = seq(0, ylimits, by = 0.1* scale)) +
  theme_classic() +
...
# outfile <- glue("Source plot/output/npi_2021_2022.tif")
# tiff(outfile, width = 20, height = 18, unit = "in", res = 300, compression = "lzw")
pdf("Source plot/output/npi_2021_2022.pdf",width = 20, height = 18)
print(finalplot)
dev.off()
