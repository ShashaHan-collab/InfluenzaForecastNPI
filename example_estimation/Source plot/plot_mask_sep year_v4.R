...
# plot northern china
# load data
TwoNpi<-read.xlsx("Source Data/plot_mask_sep year_v4/cn.xlsx", sheetName = "bothtwonpis")
Move<-read.xlsx("Source Data/plot_mask_sep year_v4/cn.xlsx", sheetName = "movementrestriction")
Mask<-read.xlsx("Source Data/plot_mask_sep year_v4/cn.xlsx", sheetName = "maskwearingorder")
NoNpi<-read.xlsx("Source Data/plot_mask_sep year_v4/cn.xlsx", sheetName = "neithertwonpis")
...
cn19Mask<-Mask%>% filter(time>=201940&time<=202039) %>%
  mutate(mean = replace(mean, time <= 202003, NA))%>%
  mutate(lower = replace(lower, time <= 202003, NA))%>%
  mutate(upper = replace(upper, time <= 202003, NA))%>%
...
# plot southern china
# load data
TwoNpi<-read.xlsx("Source Data/plot_mask_sep year_v4/cs.xlsx", sheetName = "bothtwonpis")
Move<-read.xlsx("Source Data/plot_mask_sep year_v4/cs.xlsx", sheetName = "movementrestriction")
Mask<-read.xlsx("Source Data/plot_mask_sep year_v4/cs.xlsx", sheetName = "maskwearingorder")
NoNpi<-read.xlsx("Source Data/plot_mask_sep year_v4/cs.xlsx", sheetName = "neithertwonpis")
...
# plot uk
# load data
TwoNpi<-read.xlsx("Source Data/plot_mask_sep year_v4/uk.xlsx", sheetName = "bothtwonpis")
Move<-read.xlsx("Source Data/plot_mask_sep year_v4/uk.xlsx", sheetName = "movementrestriction")
Mask<-read.xlsx("Source Data/plot_mask_sep year_v4/uk.xlsx", sheetName = "maskwearingorder")
NoNpi<-read.xlsx("Source Data/plot_mask_sep year_v4/uk.xlsx", sheetName = "neithertwonpis")
...
# plot usa
# load data
TwoNpi<-read.xlsx("Source Data/plot_mask_sep year_v4/usa.xlsx", sheetName = "bothtwonpis")
Move<-read.xlsx("Source Data/plot_mask_sep year_v4/usa.xlsx", sheetName = "movementrestriction")
Mask<-read.xlsx("Source Data/plot_mask_sep year_v4/usa.xlsx", sheetName = "maskwearingorder")
NoNpi<-read.xlsx("Source Data/plot_mask_sep year_v4/usa.xlsx", sheetName = "neithertwonpis")
...
usa19Mask<-Mask%>% filter(time>=201940&time<=202039) %>%
  ...
  mutate(lower = replace(lower, time <= 202013, NA))%>%
  mutate(upper = replace(upper, time <= 202013, NA))%>%
  mutate(scenario = "Mask-wearing alone")
...
outfile <- glue("Source plot/output/mask_2019_2021.tif")
