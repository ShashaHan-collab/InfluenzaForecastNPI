...
# load data
opt_infec.gr.vc.range1cn <- read.xlsx("Source Data/sensitivity20-21/sensitivity2021.xlsx", 
                                   sheetName = "cnm")
...
opt_infec.gr.vc.range2cn <- read.xlsx("Source Data/sensitivity20-21/sensitivity2021.xlsx", 
                                   sheetName = "cnv")
...
opt_infec.gr.vc.range3cn <- read.xlsx("Source Data/sensitivity20-21/sensitivity2021.xlsx", 
                                   sheetName = "cnn")
...
opt_infec.gr.vc.range4cn <- read.xlsx("Source Data/sensitivity20-21/sensitivity2021.xlsx", 
                                   sheetName = "cns")
...
# load data
opt_infec.gr.vc.range1cs <- read.xlsx("Source Data/sensitivity20-21/sensitivity2021.xlsx", 
                                      sheetName = "csm")
...
opt_infec.gr.vc.range2cs <- read.xlsx("Source Data/sensitivity20-21/sensitivity2021.xlsx", 
                                      sheetName = "csv")
...
opt_infec.gr.vc.range3cs <- read.xlsx("Source Data/sensitivity20-21/sensitivity2021.xlsx", 
                                      sheetName = "csn")
...
opt_infec.gr.vc.range4cs <- read.xlsx("Source Data/sensitivity20-21/sensitivity2021.xlsx", 
                                      sheetName = "css")
...
# load data
opt_infec.gr.vc.range1uk <- read.xlsx("Source Data/sensitivity20-21/sensitivity2021.xlsx", 
                                      sheetName = "ukm")
...
opt_infec.gr.vc.range2uk <- read.xlsx("Source Data/sensitivity20-21/sensitivity2021.xlsx", 
                                      sheetName = "ukv")
...
opt_infec.gr.vc.range3uk <- read.xlsx("Source Data/sensitivity20-21/sensitivity2021.xlsx", 
                                      sheetName = "ukn")
...
opt_infec.gr.vc.range4uk <- read.xlsx("Source Data/sensitivity20-21/sensitivity2021.xlsx", 
                                      sheetName = "uks")
...
# load data
opt_infec.gr.vc.range1usa <- read.xlsx("Source Data/sensitivity20-21/sensitivity2021.xlsx", 
                                       sheetName = "usam")
...
opt_infec.gr.vc.range2usa <- read.xlsx("Source Data/sensitivity20-21/sensitivity2021.xlsx", 
                                       sheetName = "usav")
...
opt_infec.gr.vc.range3usa <- read.xlsx("Source Data/sensitivity20-21/sensitivity2021.xlsx", 
                                       sheetName = "usan")
...
opt_infec.gr.vc.range4usa <- read.xlsx("Source Data/sensitivity20-21/sensitivity2021.xlsx", 
                                       sheetName = "usas")
...
outfile <- glue("Source plot/output/sensitivity20-21.tif")
