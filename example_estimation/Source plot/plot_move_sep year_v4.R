...
# plot northern china
# load data
TwoNpi<-read.xlsx("Source Data/plot_move_sep year_v4/cn.xlsx", sheetName = "bothtwonpis")
Move<-read.xlsx("Source Data/plot_move_sep year_v4/cn.xlsx", sheetName = "movementrestriction")
Mask<-read.xlsx("Source Data/plot_move_sep year_v4/cn.xlsx", sheetName = "maskwearingorder")
NoNpi<-read.xlsx("Source Data/plot_move_sep year_v4/cn.xlsx", sheetName = "neithertwonpis")
...
plotf_mask_cn19 <-ggplot()+
  ...
  geom_ribbon(aes(x = cn19xseq, ymax = upper * scale,ymin = lower*scale), fill = "#fece11", color = NA,
              alpha = 0.3, data = cn19Move)+
  # geom_ribbon(aes(x = cn19xseq, ymax = upper * scale,ymin = lower*scale), fill = "#FFC0CB", color = NA, 
  #             alpha = 0.8, data = cn19Mask)+
  geom_line(aes(x = cn19xseq, y = mean * scale, color = "Mobility change alone"), size = 1.5,data=cn19Move) +
  ...
  scale_color_manual(values = c(
    ...
    "Mobility change alone" = "#FF7800",
    "Mask-wearing alone" = "#FF7800", #"#8A2BE2",#"#FC4E07",
...
plotf_mask_cn20 <-ggplot()+
  ...
  geom_ribbon(aes(x = cn20xseq, ymax = upper * scale,ymin = lower*scale), fill = "#fece11", color = NA,
              alpha = 0.2, data = cn20Move)+
  # geom_ribbon(aes(x = cn20xseq, ymax = upper * scale,ymin = lower*scale), fill = "#FFC0CB", color = NA, 
  #             alpha = 0.8, data = cn20Mask)+
  geom_line(aes(x = cn20xseq, y = mean * scale, color = "Mobility change alone"), size = 1.5,data=cn20Move) +
...
# plot southern china
# load data
TwoNpi<-read.xlsx("Source Data/plot_move_sep year_v4/cs.xlsx", sheetName = "bothtwonpis")
Move<-read.xlsx("Source Data/plot_move_sep year_v4/cs.xlsx", sheetName = "movementrestriction")
Mask<-read.xlsx("Source Data/plot_move_sep year_v4/cs.xlsx", sheetName = "maskwearingorder")
NoNpi<-read.xlsx("Source Data/plot_move_sep year_v4/cs.xlsx", sheetName = "neithertwonpis")
...
plotf_mask_cs19 <-ggplot()+
  ...
  geom_ribbon(aes(x = cs19xseq, ymax = upper * scale,ymin = lower*scale), fill = "#fece11", color = NA,
              alpha = 0.3, data = cs19Move)+
  # geom_ribbon(aes(x = cs19xseq, ymax = upper * scale,ymin = lower*scale), fill = "#FFC0CB", color = NA, 
  #             alpha = 0.8, data = cs19Mask)+
  geom_line(aes(x = cs19xseq, y = mean * scale, color = "Mobility change alone"), size = 1.5,data=cs19Move) +
...
plotf_mask_cs20 <-ggplot()+
  ...
  geom_ribbon(aes(x = cs20xseq, ymax = upper * scale,ymin = lower*scale), fill = "#fece11", color = NA,
              alpha = 0.3, data = cs20Move)+
  # geom_ribbon(aes(x = cs20xseq, ymax = upper * scale,ymin = lower*scale), fill = "#FFC0CB", color = NA, 
  #             alpha = 0.8, data = cs20Mask)+
  geom_line(aes(x = cs20xseq, y = mean * scale, color = "Mobility change alone"), size = 1.5,data=cs20Move) +
...
# plot uk
# load data
TwoNpi<-read.xlsx("Source Data/plot_move_sep year_v4/uk.xlsx", sheetName = "bothtwonpis")
Move<-read.xlsx("Source Data/plot_move_sep year_v4/uk.xlsx", sheetName = "movementrestriction")
Mask<-read.xlsx("Source Data/plot_move_sep year_v4/uk.xlsx", sheetName = "maskwearingorder")
NoNpi<-read.xlsx("Source Data/plot_move_sep year_v4/uk.xlsx", sheetName = "neithertwonpis")
...
uk19Move<-Move%>% filter(time>=201940&time<=202039)%>%
  mutate(mean = replace(mean, time <= 202010, NA))%>%
  mutate(scenario = "Mobility change alone")
...
plotf_mask_uk19 <-ggplot()+
  ...
  geom_ribbon(aes(x = uk19xseq, ymax = upper * scale,ymin = lower*scale), fill = "#fece11", color = NA,
              alpha = 0.3, data = uk19Move)+
  # geom_ribbon(aes(x = uk19xseq, ymax = upper * scale,ymin = lower*scale), fill = "#FFC0CB", color = NA, 
  #             alpha = 0.8, data = uk19Mask)+
  geom_line(aes(x = uk19xseq, y = mean * scale, color = "Mobility change alone"), size = 1.5,data=uk19Move) +
...
plotf_mask_uk20 <-ggplot()+
  ...
  geom_ribbon(aes(x = uk20xseq, ymax = upper * scale,ymin = lower*scale), fill = "#fece11", color = NA,
              alpha = 0.3, data = uk20Move)+
  # geom_ribbon(aes(x = uk20xseq, ymax = upper * scale,ymin = lower*scale), fill = "#FFC0CB", color = NA, 
  #             alpha = 0.8, data = uk20Mask)+
  geom_line(aes(x = uk20xseq, y = mean * scale, color = "Mobility change alone"), size = 1.5,data=uk20Move) +
...
# plot usa
# load data
TwoNpi<-read.xlsx("Source Data/plot_move_sep year_v4/usa.xlsx", sheetName = "bothtwonpis")
Move<-read.xlsx("Source Data/plot_move_sep year_v4/usa.xlsx", sheetName = "movementrestriction")
Mask<-read.xlsx("Source Data/plot_move_sep year_v4/usa.xlsx", sheetName = "maskwearingorder")
NoNpi<-read.xlsx("Source Data/plot_move_sep year_v4/usa.xlsx", sheetName = "neithertwonpis")
...
usa19Mask<-Mask%>% filter(time>=201940&time<=202039) %>%
  mutate(mean = replace(mean, time <= 202013, NA))%>%
  mutate(scenario = "Mask-wearing alone")
...
plotf_mask_usa19 <-ggplot()+
  ...
  geom_ribbon(aes(x = usa19xseq, ymax = upper * scale,ymin = lower*scale), fill = "#fece11", color = NA,
              alpha = 0.3, data = usa19Move)+
  # geom_ribbon(aes(x = usa19xseq, ymax = upper * scale,ymin = lower*scale), fill = "#FFC0CB", color = NA, 
  #             alpha = 0.8, data = usa19Mask)+
  geom_line(aes(x = usa19xseq, y = mean * scale, color = "Mobility change alone"), size = 1.5,data=usa19Move) +
...
plotf_mask_usa20 <-ggplot()+
  ...
  geom_ribbon(aes(x = usa20xseq, ymax = upper * scale,ymin = lower*scale), fill = "#fece11", color = NA,
              alpha = 0.3, data = usa20Move)+
  # geom_ribbon(aes(x = usa20xseq, ymax = upper * scale,ymin = lower*scale), fill = "#FFC0CB", color = NA, 
  #             alpha = 0.8, data = usa20Mask)+
  geom_line(aes(x = usa20xseq, y = mean * scale, color = "Mobility change alone"), size = 1.5,data=usa20Move) +
...
prow <- plot_grid(plotf_mask_cn19 + labs(x = ""),
                  NULL,
                  plotf_mask_cs19 + theme(legend.position = "none") + labs(x = "", y = ""),
                  NULL,
                  plotf_mask_uk19 + theme(legend.position = "none") + labs(x = "", y = ""),
                  NULL,
                  plotf_mask_usa19 + theme(legend.position = "none") + labs(x = "", y = ""),
                  NULL,
                  plotf_mask_cn20 + theme(legend.position = "none"),
                  NULL,
                  plotf_mask_cs20 + theme(legend.position = "none") + labs(y = ""),
                  NULL,
...
outfile <- glue("Source plot/output/mobility_2019_2021.tif")
