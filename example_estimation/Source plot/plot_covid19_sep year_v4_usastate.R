...
# season 19-20
# load data
NoCovid19<-read.xlsx("Source Data/plot_covid19_sep year_v4_usastate/mn.xlsx",  sheetName = "nocovid19")
Covid19<-read.xlsx("Source Data/plot_covid19_sep year_v4_usastate/mn.xlsx",  sheetName = "covid19")
...
# season 19-20
# load data
NoCovid19<-read.xlsx("Source Data/plot_covid19_sep year_v4_usastate/co.xlsx",  sheetName = "nocovid19")
Covid19<-read.xlsx("Source Data/plot_covid19_sep year_v4_usastate/co.xlsx",  sheetName = "covid19")
...
# season 19-20
# load data
NoCovid19<-read.xlsx("Source Data/plot_covid19_sep year_v4_usastate/in.xlsx",  sheetName = "nocovid19")
Covid19<-read.xlsx("Source Data/plot_covid19_sep year_v4_usastate/in.xlsx",  sheetName = "covid19")
...
# season 19-20
# load data
NoCovid19<-read.xlsx("Source Data/plot_covid19_sep year_v4_usastate/wa.xlsx",  sheetName = "nocovid19")
Covid19<-read.xlsx("Source Data/plot_covid19_sep year_v4_usastate/wa.xlsx",  sheetName = "covid19")
...
prow <- plot_grid(plotf_covid19cs19 + labs(x = ""),
                  NULL,
                  plotf_covid19uk19 + theme(legend.position = "none") + labs(x = "", y = ""),
                  NULL,
                  plotf_covid19cn19 + theme(legend.position = "none") + labs(x = "", y = ""),
                  NULL,
                  plotf_covid19usa19 + theme(legend.position = "none") + labs(x = "", y = ""),
                  NULL,
                  plotf_covid19cs20 + theme(legend.position = "none"),
                  NULL,
                  plotf_covid19uk20 + theme(legend.position = "none") + labs(y = ""),
                  NULL,
                  plotf_covid19cn20 + theme(legend.position = "none") + labs(y = ""), 
                  NULL,
...
outfile <- glue("Source plot/output/virus_2019_2021_usastate.tif")
