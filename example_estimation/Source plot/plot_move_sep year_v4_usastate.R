...
# plot Minnesota
# load data
TwoNpi<-read.xlsx("Source Data/plot_move_sep year_v4_usastate/mn.xlsx", sheetName = "bothtwonpis")
Move<-read.xlsx("Source Data/plot_move_sep year_v4_usastate/mn.xlsx", sheetName = "movementrestriction")
Mask<-read.xlsx("Source Data/plot_move_sep year_v4_usastate/mn.xlsx", sheetName = "maskwearingorder")
NoNpi<-read.xlsx("Source Data/plot_move_sep year_v4_usastate/mn.xlsx", sheetName = "neithertwonpis")
...
# plot Colorado
# load data
TwoNpi<-read.xlsx("Source Data/plot_move_sep year_v4_usastate/co.xlsx", sheetName = "bothtwonpis")
Move<-read.xlsx("Source Data/plot_move_sep year_v4_usastate/co.xlsx", sheetName = "movementrestriction")
Mask<-read.xlsx("Source Data/plot_move_sep year_v4_usastate/co.xlsx", sheetName = "maskwearingorder")
NoNpi<-read.xlsx("Source Data/plot_move_sep year_v4_usastate/co.xlsx", sheetName = "neithertwonpis")
...
# plot uk
# load data
TwoNpi<-read.xlsx("Source Data/plot_move_sep year_v4_usastate/in.xlsx", sheetName = "bothtwonpis")
Move<-read.xlsx("Source Data/plot_move_sep year_v4_usastate/in.xlsx", sheetName = "movementrestriction")
Mask<-read.xlsx("Source Data/plot_move_sep year_v4_usastate/in.xlsx", sheetName = "maskwearingorder")
NoNpi<-read.xlsx("Source Data/plot_move_sep year_v4_usastate/in.xlsx", sheetName = "neithertwonpis")
...
# plot usa
# load data
TwoNpi<-read.xlsx("Source Data/plot_move_sep year_v4_usastate/wa.xlsx", sheetName = "bothtwonpis")
Move<-read.xlsx("Source Data/plot_move_sep year_v4_usastate/wa.xlsx", sheetName = "movementrestriction")
Mask<-read.xlsx("Source Data/plot_move_sep year_v4_usastate/wa.xlsx", sheetName = "maskwearingorder")
NoNpi<-read.xlsx("Source Data/plot_move_sep year_v4_usastate/wa.xlsx", sheetName = "neithertwonpis")
...
usa19Mask<-Mask%>% filter(time>=201940&time<=202039) %>%
  mutate(mean = replace(mean, time <= 202016, NA))%>%
  mutate(scenario = "Mask-wearing alone")
...
outfile <- glue("Source plot/output/mobility_2019_2021_usastate.tif")
