...
python script/name_data.py --lag 52 --region cni --tstart 201140 --tend 201752 --vstart 201801 --vend 201852 --pstart 202004 --pend 202004 --cov volume,vw --lsa 1e-05 --CI --targetname cncoefval --targetfolder result --sourcetype coef
...
python script/gen_data_plot.py --sourcecsv cnval18 --targetexcel preprocessed_data/colleterialeffects/cn --targetsheetname val18
# southern china
...
python script/name_data.py --lag 52 --region csib3 --tstart 201140 --tend 201752 --vstart 201801 --vend 201852 --pstart 202004 --pend 202004 --cov volume,vw --lsa 1e-05 --CI --targetname cscoefval --targetfolder result --sourcetype coef
...
python script/gen_data_plot.py --sourcecsv csval18 --targetexcel preprocessed_data/colleterialeffects/cs --targetsheetname val18
# uk
...
python script/name_data.py --lag 52 --region uk --tstart 201140 --tend 201752 --vstart 201801 --vend 201852 --pstart 202011 --pend 202011 --cov volume,vw --lsa 1e-05 --CI --targetname ukcoefval --targetfolder result --sourcetype coef
...
python script/gen_data_plot.py --sourcecsv ukval18 --targetexcel preprocessed_data/colleterialeffects/uk --targetsheetname val18
# usa
...
python script/name_data.py --lag 52 --region usa --tstart 201140 --tend 201752 --vstart 201801 --vend 201852 --pstart 202012 --pend 202012 --cov volume,vw --lsa 1e-05 --CI --targetname usacoefval --targetfolder result --sourcetype coef
...
python script/gen_data_plot.py --sourcecsv usaval18 --targetexcel preprocessed_data/colleterialeffects/usa --targetsheetname val18