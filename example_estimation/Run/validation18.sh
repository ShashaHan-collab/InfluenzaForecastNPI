...
python script/auxiliary_gen_excel_data.py --sourcecsv cnval18 --targetexcel result/colleterialeffects/cn --targetsheetname val18
# southern china
...
python script/auxiliary_gen_excel_data.py --sourcecsv csval18 --targetexcel result/colleterialeffects/cs --targetsheetname val18
# england
...
python script/auxiliary_gen_excel_data.py --sourcecsv ukval18 --targetexcel result/colleterialeffects/uk --targetsheetname val18
# usa
...
python script/auxiliary_gen_excel_data.py --sourcecsv usaval18 --targetexcel result/colleterialeffects/usa --targetsheetname val18