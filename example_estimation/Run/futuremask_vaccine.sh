...
python script/gen_data_plot.py --sourcecsv cnnovaccine_30 --targetexcel preprocessed_data/future/cn --targetsheetname novaccine_30
...
python script/name_data.py --lag 52 --region cnlog --tstart 202004 --tend 202128 --pstart 202128 --pend 202252 --ctype new --clag 13 --yam cnihatyv2vaccine --model lr --cpl a0 --noint --cpltp 202140 --targetname cnvaccine --targetfolder preprocessed_data/ci
...
python script/gen_data_plot.py --sourcecsv cnvaccine --targetexcel preprocessed_data/future/cn --targetsheetname vaccine
...
python script/gen_data_plot.py --sourcecsv cnvaccine_30 --targetexcel preprocessed_data/future/cn --targetsheetname vaccine_30
# southern china
# make data
# flu level with novaccine and mask level at 30%
...
python script/gen_data_plot.py --sourcecsv csnovaccine_30 --targetexcel preprocessed_data/future/cs --targetsheetname novaccine_30
# make flu level with vaccination under mitigate travel volume
...
python script/name_data.py --lag 52 --region cslog --tstart 202004 --tend 202128 --pstart 202128 --pend 202252 --ctype new --clag 11 --yam csihatyv2vaccine --model lr --cpl a0 --noint --cpltp 202140 --targetname csvaccine --targetfolder preprocessed_data/ci
...
python script/gen_data_plot.py --sourcecsv csvaccine --targetexcel preprocessed_data/future/cs --targetsheetname vaccine
# flu level with vaccination and with mask wearing at 30%
...
python script/gen_data_plot.py --sourcecsv csvaccine_30 --targetexcel preprocessed_data/future/cs --targetsheetname vaccine_30
# uk
# data
# flu level with novaccine and mask level at 30%
...
python script/gen_data_plot.py --sourcecsv uknovaccine_30 --targetexcel preprocessed_data/future/uk --targetsheetname novaccine_30
# make flu level with vaccination under mitigate travel volume
...
python script/name_data.py --lag 52 --region uklog --tstart 202030 --tend 202128 --pstart 202128 --pend 202252 --ctype new --clag 24 --yam uk3hatyv2vaccine --model lr --cpl a0 --noint --cpltp 202140 --targetname ukvaccine --targetfolder preprocessed_data/ci
...
python script/gen_data_plot.py --sourcecsv ukvaccine --targetexcel preprocessed_data/future/uk --targetsheetname vaccine
# flu level with vaccination and with mask wearing at 30%
...
python script/gen_data_plot.py --sourcecsv ukvaccine_30 --targetexcel preprocessed_data/future/uk --targetsheetname vaccine_30
# usa
# make data
# flu level with novaccine and mask level at 30%
...
python script/gen_data_plot.py --sourcecsv usanovaccine_30 --targetexcel preprocessed_data/future/usa --targetsheetname novaccine_30
# make flu level with vaccination under mitigate travel volume
...
python script/name_data.py --lag 52 --region usa --tstart 202014 --tend 202128 --pstart 202128 --pend 202252 --ctype new --clag 35 --yam usa3hatyv2vaccine --model lr --cpl a0 --noint --cpltp 202140  --targetname usavaccine --targetfolder preprocessed_data/ci
...
python script/gen_data_plot.py --sourcecsv usavaccine --targetexcel preprocessed_data/future/usa --targetsheetname vaccine
# flu level with vaccination and with mask wearing at 30%
...
python script/gen_data_plot.py --sourcecsv usavaccine_30 --targetexcel preprocessed_data/future/usa --targetsheetname vaccine_30
