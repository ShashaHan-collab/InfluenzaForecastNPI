...
python script/gen_data_plot.py --sourcecsv cnval17 --targetexcel preprocessed_data/colleterialeffects/cn --targetsheetname val17
# southern china
...
python script/gen_data_plot.py --sourcecsv csval17 --targetexcel preprocessed_data/colleterialeffects/cs --targetsheetname val17
# uk
...
python script/gen_data_plot.py --sourcecsv ukval17 --targetexcel preprocessed_data/colleterialeffects/uk --targetsheetname val17
# usa
...
python script/gen_data_plot.py --sourcecsv usaval17 --targetexcel preprocessed_data/colleterialeffects/usa --targetsheetname val17