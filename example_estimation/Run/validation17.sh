...
python script/auxiliary_gen_excel_data.py --sourcecsv cnval17 --targetexcel result/colleterialeffects/cn --targetsheetname val17
# southern china
...
python script/auxiliary_gen_excel_data.py --sourcecsv csval17 --targetexcel result/colleterialeffects/cs --targetsheetname val17
# uk
...
python script/auxiliary_gen_excel_data.py --sourcecsv ukval17 --targetexcel result/colleterialeffects/uk --targetsheetname val17
# usa
...
python script/auxiliary_gen_excel_data.py --sourcecsv usaval17 --targetexcel result/colleterialeffects/usa --targetsheetname val17