...
python script/gen_data_plot.py --sourcecsv hbnocovid --targetexcel preprocessed_data/covid19/hb --targetsheetname nocovid19
python script/name_data.py --lag 52 --region hbv2 --tstart 201140 --tend 201952 --pstart 202001 --pend 202139 --cov volume,vw --lsa 1e-05 --targetname hbnocovid --targetfolder preprocessed_data/ci
...
python script/gen_data_plot.py --sourcecsv hbcovid --targetexcel preprocessed_data/covid19/hb --targetsheetname covid19
python script/name_data.py --lag 52 --region hbv2 --tstart 201140 --tend 202003 --pstart 202004 --pend 202139 --cov volume,vw --lsa 1e-05 --targetname hbcovid --targetfolder preprocessed_data/ci