...
python script/auxiliary_gen_excel_data.py --sourcecsv hbnocovid --targetexcel result/covid19/hb --targetsheetname nocovid19
python script/auxiliary_name_file.py --lag 52 --region hbv2 --tstart 201140 --tend 201952 --pstart 202001 --pend 202139 --cov volume,vw --lsa 1e-05 --targetname hbnocovid --targetfolder result/ci
...
python script/auxiliary_gen_excel_data.py --sourcecsv hbcovid --targetexcel result/covid19/hb --targetsheetname covid19
python script/auxiliary_name_file.py --lag 52 --region hbv2 --tstart 201140 --tend 202003 --pstart 202004 --pend 202139 --cov volume,vw --lsa 1e-05 --targetname hbcovid --targetfolder result/ci